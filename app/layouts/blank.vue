          ...
          <div class="hidden lg:flex items-center gap-4">
            <template v-if="isLoggedIn">
              ...
              >
                ...
                <div
                  class="absolute inset-0 bg-linear-to-r from-emerald-600 to-lime-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                ></div>
              </NuxtLink>
            </template>
            <template v-else>
              <NuxtLink
                to="/login"
                class="magnetic-btn relative px-6 py-2 text-sm font-medium text-white bg-linear-to-r from-emerald-500 via-teal-500 to-lime-500 rounded-full hover:shadow-lg hover:shadow-emerald-500/25 transition-all duration-300 overflow-hidden group"
              >
                <span class="relative z-10">Đăng nhập</span>
                <div
                  class="absolute inset-0 bg-linear-to-r from-emerald-500 via-teal-500 to-lime-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                ></div>
              </NuxtLink>
            </template>
          </div>
          ...
          >
            <template v-if="isLoggedIn">
              <NuxtLink
                to="/dashboard"
                @click="mobileMenuOpen = false"
                class="flex items-center justify-center gap-2 w-full px-4 py-4 text-white bg-linear-to-r from-emerald-500 via-teal-500 to-lime-500 rounded-xl font-medium"
              >
                <i class="bi bi-grid-3x3-gap"></i>
                Dashboard
              </NuxtLink>
